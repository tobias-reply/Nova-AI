...
- With image /dev:
Perfect everything works perfectly. Now could you update the code so it doesn't send text anymore but a photo that i can upload? Nova Lite should simply respond what can be seen in the picture. Here is how to make requests to the model using pictures: # Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
